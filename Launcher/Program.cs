...
switch (provider.ProjectName)
{
    ...
    case "FortniteGame":
    {
        ...
        scene.Children.Add(new WorldActor(provider.LoadPackageObject<UWorld>("FortniteGame/Plugins/GameFeatures/WildEstate/Content/Maps/WildEstate_Terrain.WildEstate_Terrain"), WorldActorType.BaseResolution | WorldActorType.WorldPartition));
        ...
        // scene.Children.Add(new WorldActor(provider.LoadPackageObject<UWorld>("FortniteGame/Plugins/GameFeatures/Figment/Figment_S06_Map/Content/Athena_Terrain_S06.Athena_Terrain_S06"), WorldActorType.Landscape));
        break;
    }
}
